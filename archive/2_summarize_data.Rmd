...
get_census_decennial_data <- function(territory_config, decennial_year = 2020) {
  ...
  message("\n==================================================")
  message(sprintf("Starting decennial data pull for territory: %s", toupper(territory_config$usps)))
  message("==================================================")
  ...
  message(sprintf("Number of variables to pull: %d", length(territory_config$vars)))
