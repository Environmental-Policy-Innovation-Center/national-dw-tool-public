...
territory_config <- list(
  GU = list(sumfile = "dpgu", geography = "place", var_col = "dpgu_var"),
  MP = list(sumfile = "dpmp", geography = "place", var_col = "dpmp_var"),
  AS = list(sumfile = "dpas", geography = "place", var_col = "dpas_var"),
  VI = list(sumfile = "dpvi", geography = "place", var_col = "dpvi_var")
)
...
territory_var_vectors <- lapply(territory_config, function(cfg) {
  ...
  list(
    DP  = vars_named[startsWith(vars_named, "DP")],
    INC = vars_named[vars_named %in% territory_income_vars]  # keep for later interpolation
  )
})
...
territory_census_data <- purrr::imap_dfr(
  ...
  \(cfg, state_code) {
    pull_decennial(
      state_code,
      cfg,
      territory_var_vectors[[state_code]]$DP
    )
  }
)
